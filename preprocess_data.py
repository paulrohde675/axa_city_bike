...
def test_train_split(df: pd.DataFrame, cfg: Config) -> list[pd.DataFrame | pd.Series]:
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X, y, test_size=cfg.test_split, random_state=cfg.random_state
    )
...
def scale_data(
    cfg: Config, X_train: pd.DataFrame, y_train: pd.Series, X_test: pd.DataFrame
